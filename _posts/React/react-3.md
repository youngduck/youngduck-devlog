...
| 4. 서브셋 추출        | 2,405KB → 11.6KB / 7.51초 → 193ms (97%↓) | 적용                              |

## 마치며

font-display: swap + 셀프호스팅 WOFF2까지 적용했을때는 빠른 4G 기준 폰트 로딩 시간이 **7.96초 → 6.66초**로 약 16% 개선에 그쳤는데, 서브셋까지 적용하고 나니 **2,405KB → 11.6KB**로 줄어들어 p90정도의 네트워크 속도를 가진 유저도 FOUT을 사실상 체감할 수 없는 서비스를 만들 수 있게 되었습니다. 읽어주셔서 감사합니다
